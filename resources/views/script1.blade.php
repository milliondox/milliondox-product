                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('.button-spinner')
                                    .remove(); // Remove spinner from the button
                                fetchBoardNoticeData();
                                refreshTableData();
                                toastr.success(
                                    'File uploaded successfully!'
                                ); // Display success toaster message
                                $('#board_Notices_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-td').text(response.count);
                                $('#total-size-td').text((response
                                ...
                                $('#fileUploadForm').find(
                                    ...
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                                    });
                                clearSelectedFile
                                    (); // Clear selected file div
                                clearBrowserCache();
                                submitButton.prop('disabled',
                                    false); // Re-enable the submit button
                                isSubmitting =
                                    false; // Reset submitting flag
                            ...
                            $('#entries-count-td').text(response.count);
                            $('#total-size-td').text((response.totalSize / 1024)
                                .toFixed(2) + ' KB');
                            $('#fileUploadForm')[0].reset(); // Reset the form
                            $('#fileUploadForm').find('input[type="file"]').each(
                                function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.dataRooms.forEach(function(dataRoom) {
                        $('#dataRoomSelect').append('<option value="' + dataRoom
                            .id + '">' + dataRoom.name + '</option>');
                    });
                },
        ...
        $('#confirmMoveBtn').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#dataRoomModal').modal(
                        'hide'); // Close the modal after successful move
                },
                error: function(error) {
        ...
        $(document).on('click', '#delbtdtst1', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/softdeleteCommonFile/' +
                            id, // The route you defined in web.php
        ...
        function fetchBoardMinBookData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    console.log($('#total-sizeminbook-td').text((response.totalSize / 1024).toFixed(
                        2) + ' KB'));
                },
                error: function(xhr, status, error) {
                    console.error('Failed to fetch data:', status, error);
            ...
            $('#fileUploadForm155').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#board_minut_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-countminbook-td').text(response
                                    .count);
                                $('#total-sizeminbook-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForm155')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForm155').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-countminbook-td').text(response.count);
                            $('#total-sizeminbook-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForm155')[0].reset(); // Reset the form
                            $('#fileUploadForm155').find('input[type="file"]').each(
                                function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#board_minut_pop').modal('hide'); // Hide the modal
                        $('#entries-countminbook-td').text(response.count);
                        $('#total-sizeminbook-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadForm155')[0].reset(); // Reset the form
                        $('#fileUploadForm155').find('input[type="file"]').each(
                            function() {
        ...
        function fetchBoardAttendencesheetData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    console.log($('#total-sizeboardas-td').text((response.totalSize / 1024).toFixed(
                        2) + ' KB'));
                },
                error: function(xhr, status, error) {
                    console.error('Failed to fetch data:', status, error);
            ...
            $('#fileUploadForm2').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#board_atandence_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-countboardas-td').text(response
                                    .count);
                                $('#total-sizeboardas-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForm2')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForm2').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#board_atandence_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-countboardas-td').text(response.count);
                            $('#total-sizeboardas-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForm2')[0].reset(); // Reset the form
                            $('#fileUploadForm2').find('input[type="file"]').each(
                                function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-countboardas-td').text(response.count);
                        $('#total-sizeboardas-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadForm2')[0].reset(); // Reset the form
                        $('#fileUploadForm2').find('input[type="file"]').each(
                            function() {
        ...
        function fetchBoardResolutionData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-sizeboardreso-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');

                    console.log($('#total-sizeboardreso-td').text((response.totalSize / 1024)
                        .toFixed(2) + ' KB'));
                },
                error: function(xhr, status, error) {
                    console.error('Failed to fetch data:', status, error);
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#board_Resolutions_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-countboardreso-td').text(
                                    response.count);
                                $('#total-sizeboardreso-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForm3')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForm3').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#board_Resolutions_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-countboardreso-td').text(response.count);
                            $('#total-sizeboardreso-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForm3')[0].reset(); // Reset the form
                            $('#fileUploadForm3').find('input[type="file"]').each(
                                function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
        ...
        function fetchBankAccsData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-sizebankstatement-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#bankaccstatement').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#bankaccstatement_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-countbankstatement-td').text(
                                    response.count);
                                $('#total-sizebankstatement-td').text((
                                        response.totalSize / 1024)
                                    .toFixed(2) + ' KB');
                                $('#bankaccstatement')[0]
                                    .reset(); // Reset the form
                                $('#bankaccstatement').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#bankaccstatement_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-countbankstatement-td').text(response
                                .count);
                            $('#total-sizebankstatement-td').text((response
                                .totalSize / 1024).toFixed(2) + ' KB');
                            $('#bankaccstatement')[0].reset(); // Reset the form
                            $('#bankaccstatement').find('input[type="file"]').each(
                                function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-countbankstatement-td').text(response.count);
                        $('#total-sizebankstatement-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#bankaccstatement')[0].reset(); // Reset the form
                        $('#bankaccstatement').find('input[type="file"]').each(
                            function() {
                    ...
                    if (response && Array.isArray(response.files)) {
                        ...
                        if (filteredFiles.length === 0 && selectedBank) {
                            ...
                            Swal.fire({
                                ...
                                text: 'No data available for the selected bank: ' +
                                    selectedBank
                            });

                            // Show message inside the table body
                            tableBody.html(
                                '<tr><td colspan="7" class="text-center">No data available for the selected bank.</td></tr>'
                            );
        ...
        function fetchMeetNoticeData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-genmeet-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadFormmeet').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#anual_Notices_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-genmeet-td').text(response
                                    .count);
                                $('#total-size-genmeet-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormmeet')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormmeet').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-genmeet-td').text(response.count);
                            $('#total-size-genmeet-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormmeet')[0].reset(); // Reset the form
                            $('#fileUploadFormmeet').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#anual_Notices_pop').modal('hide'); // Hide the modal
                        $('#entries-count-genmeet-td').text(response.count);
                        $('#total-size-genmeet-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadFormmeet')[0].reset(); // Reset the form
                        $('#fileUploadFormmeet').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchMeetMinBookData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-genmeet1-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#anual_minut_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-genmeet1-td').text(
                                    response.count);
                                $('#total-size-genmeet1-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormmeet1')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormmeet1').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-genmeet1-td').text(response.count);
                            $('#total-size-genmeet1-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormmeet1')[0].reset(); // Reset the form
                            $('#fileUploadFormmeet1').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#total-size-genmeet1-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#fileUploadFormmeet1')[0].reset(); // Reset the form
                        $('#fileUploadFormmeet1').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchMeetASData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-genmeet2-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#anual_atandence_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-genmeet2-td').text(
                                    response.count);
                                $('#total-size-genmeet2-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormmeet2')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormmeet2').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#anual_atandence_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-genmeet2-td').text(response.count);
                            $('#total-size-genmeet2-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormmeet2')[0].reset(); // Reset the form
                            $('#fileUploadFormmeet2').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#total-size-genmeet2-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#fileUploadFormmeet2')[0].reset(); // Reset the form
                        $('#fileUploadFormmeet2').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchMeetRESOData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-genmeet3-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#anual_Resolutions_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-genmeet3-td').text(
                                    response.count);
                                $('#total-size-genmeet3-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormmeet3')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormmeet3').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#anual_Resolutions_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-genmeet3-td').text(response.count);
                            $('#total-size-genmeet3-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormmeet3')[0].reset(); // Reset the form
                            $('#fileUploadFormmeet3').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#total-size-genmeet3-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#fileUploadFormmeet3')[0].reset(); // Reset the form
                        $('#fileUploadFormmeet3').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
            ...
            $('#fileUploadFormorder').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#ordinary_Notices_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order-td').text(response
                                    .count);
                                $('#total-size-order-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormorder')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormorder').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#ordinary_Notices_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-order-td').text(response.count);
                            $('#total-size-order-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormorder')[0].reset(); // Reset the form
                            $('#fileUploadFormorder').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-count-order-td').text(response.count);
                        $('#total-size-order-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadFormorder')[0].reset(); // Reset the form
                        $('#fileUploadFormorder').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
            ...
            $('#fileUploadFormorder1').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#ordinary_minut_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order1-td').text(response
                                    .count);
                                $('#total-size-order1-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormorder1')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormorder1').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#ordinary_minut_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-order1-td').text(response.count);
                            $('#total-size-order1-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormorder1')[0].reset(); // Reset the form
                            $('#fileUploadFormorder1').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-count-order1-td').text(response.count);
                        $('#total-size-order1-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadFormorder1')[0].reset(); // Reset the form
                        $('#fileUploadFormorder1').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#ordinary_atandence_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order2-td').text(response
                                    .count);
                                $('#total-size-order2-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormorder33')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormorder33').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#ordinary_atandence_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-order2-td').text(response.count);
                            $('#total-size-order2-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormorder33')[0]
                                .reset(); // Reset the form
                            $('#fileUploadFormorder33').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#ordinary_atandence_pop').modal(
                            'hide'); // Hide the modal
                        $('#entries-count-order2-td').text(response.count);
                        $('#total-size-order2-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadFormorder33')[0].reset(); // Reset the form
                        $('#fileUploadFormorder33').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchOrderRESOData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order31-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#ordinary_Resolutions_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order31-td').text(response
                                    .count);
                                $('#total-size-order31-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormorder31')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormorder31').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#ordinary_Resolutions_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-order31-td').text(response.count);
                            $('#total-size-order31-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormorder31')[0]
                                .reset(); // Reset the form
                            $('#fileUploadFormorder31').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#ordinary_Resolutions_pop').modal(
                            'hide'); // Hide the modal
                        $('#entries-count-order31-td').text(response.count);
                        $('#total-size-order31-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadFormorder31')[0].reset(); // Reset the form
                        $('#fileUploadFormorder31').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchInnerRunsData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order30-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadForminner').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#inco_run_form_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order30-td').text(response
                                    .count);
                                $('#total-size-order30-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForminner')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForminner').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-order30-td').text(response.count);
                            $('#total-size-order30-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForminner')[0].reset(); // Reset the form
                            $('#fileUploadForminner').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#inco_run_form_pop').modal('hide'); // Hide the modal
                        $('#entries-count-order30-td').text(response.count);
                        $('#total-size-order30-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadForminner')[0].reset(); // Reset the form
                        $('#fileUploadForminner').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchInnerINC9Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order32-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadForminner2').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#inco_INC_9_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order32-td').text(response
                                    .count);
                                $('#total-size-order32-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForminner2')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForminner2').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-order32-td').text(response.count);
                            $('#total-size-order32-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForminner2')[0].reset(); // Reset the form
                            $('#fileUploadForminner2').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#inco_INC_9_pop').modal('hide'); // Hide the modal
                        $('#entries-count-order32-td').text(response.count);
                        $('#total-size-order32-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadForminner2')[0].reset(); // Reset the form
                        $('#fileUploadForminner2').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchInnerspiceData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order33-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadForminner3').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#inco_SPICe_Part_B_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order33-td').text(response
                                    .count);
                                $('#total-size-order33-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForminner3')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForminner3').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#inco_SPICe_Part_B_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-order33-td').text(response.count);
                            $('#total-size-order33-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForminner3')[0].reset(); // Reset the form
                            $('#fileUploadForminner3').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-count-order33-td').text(response.count);
                        $('#total-size-order33-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadForminner3')[0].reset(); // Reset the form
                        $('#fileUploadForminner3').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchInnerINC33Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order34-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadForminc33').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#inco_INC_33_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order34-td').text(response
                                    .count);
                                $('#total-size-order34-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForminc33')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForminc33').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-order34-td').text(response.count);
                            $('#total-size-order34-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForminc33')[0].reset(); // Reset the form
                            $('#fileUploadForminc33').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#inco_INC_33_pop').modal('hide'); // Hide the modal
                        $('#entries-count-order34-td').text(response.count);
                        $('#total-size-order34-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fileUploadForminc33')[0].reset(); // Reset the form
                        $('#fileUploadForminc33').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchInnerINC34Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order35t-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadForminnerinc34').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#inco_INC_34_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order35t-td').text(
                                    response.count);
                                $('#total-size-order35t-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForminnerinc34')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForminnerinc34').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-order35t-td').text(response.count);
                            $('#total-size-order35t-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForminnerinc34')[0]
                                .reset(); // Reset the form
                            $('#fileUploadForminnerinc34').find(
                    ...
                    error: function() {
                        ...
                        $('#fileUploadForminnerinc34').find('input[type="file"]')
                            .each(function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchInnerINC35Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order36t-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadForminnerinc35').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#inco_INC_35_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order36t-td').text(
                                    response.count);
                                $('#total-size-order36t-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForminnerinc35')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForminnerinc35').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-order36t-td').text(response.count);
                            $('#total-size-order36t-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForminnerinc35')[0]
                                .reset(); // Reset the form
                            $('#fileUploadForminnerinc35').find(
                    ...
                    error: function() {
                        ...
                        $('#fileUploadForminnerinc35').find('input[type="file"]')
                            .each(function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchInnerINC22Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order37t-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadForminnerinc22').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#inco_INC_22_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order37t-td').text(
                                    response.count);
                                $('#total-size-order37t-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForminnerinc22')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForminnerinc22').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-order37t-td').text(response.count);
                            $('#total-size-order37t-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForminnerinc22')[0]
                                .reset(); // Reset the form
                            $('#fileUploadForminnerinc22').find(
                    ...
                    error: function() {
                        ...
                        $('#fileUploadForminnerinc22').find('input[type="file"]')
                            .each(function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchInnerINC20AData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order38t-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#inco_INC_20A_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order38t-td').text(
                                    response.count);
                                $('#total-size-order38t-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadForminc20a')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadForminc20a').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-order38t-td').text(response.count);
                            $('#total-size-order38t-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadForminc20a')[0].reset(); // Reset the form
                            $('#fileUploadForminc20a').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#total-size-order38t-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#fileUploadForminc20a')[0].reset(); // Reset the form
                        $('#fileUploadForminc20a').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchAnnAoc4AfsAData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order399t-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadFormann1').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#filling_AoC_4_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order399t-td').text(
                                    response.count);
                                $('#total-size-order399t-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fileUploadFormann1')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormann1').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#entries-count-order399t-td').text(response.count);
                            $('#total-size-order399t-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fileUploadFormann1')[0].reset(); // Reset the form
                            $('#fileUploadFormann1').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#total-size-order39t-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#fileUploadFormann1')[0].reset(); // Reset the form
                        $('#fileUploadFormann1').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchAnnAoc4CfsAData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order400tt-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadFormann2').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#filling_AoC_4_cfs_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order400tt-td').text(
                                    response.count);
                                $('#total-size-order400tt-td').text((
                                        response.totalSize / 1024)
                                    .toFixed(2) + ' KB');
                                $('#fileUploadFormann2')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormann2').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#filling_AoC_4_cfs_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-order400tt-td').text(response.count);
                            $('#total-size-order400tt-td').text((response
                                .totalSize / 1024).toFixed(2) + ' KB');
                            $('#fileUploadFormann2')[0].reset(); // Reset the form
                            $('#fileUploadFormann2').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-count-order400tt-td').text(response.count);
                        $('#total-size-order400tt-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#fileUploadFormann2')[0].reset(); // Reset the form
                        $('#fileUploadFormann2').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchAnnmgt7aData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order402tt-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#fileUploadFormann4').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#filling_MGT_7a_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-order402tt-td').text(
                                    response.count);
                                $('#total-size-order402tt-td').text((
                                        response.totalSize / 1024)
                                    .toFixed(2) + ' KB');
                                $('#fileUploadFormann4')[0]
                                    .reset(); // Reset the form
                                $('#fileUploadFormann4').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#filling_MGT_7a_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-order402tt-td').text(response.count);
                            $('#total-size-order402tt-td').text((response
                                .totalSize / 1024).toFixed(2) + ' KB');
                            $('#fileUploadFormann4')[0].reset(); // Reset the form
                            $('#fileUploadFormann4').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-count-order402tt-td').text(response.count);
                        $('#total-size-order402tt-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#fileUploadFormann4')[0].reset(); // Reset the form
                        $('#fileUploadFormann4').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
        ...
        function fetchAnnmgt7Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-order401tt-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
        ...
        function fetchdirectorappointmentsdir3dinData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-directdirno3-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
        ...
        function fetchdirectorappointmentsdir3Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-directdir3-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#dir_3_pop').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#director_DIR_3_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-directdir3-td').text(
                                    response.count);
                                $('#total-size-directdir3-td').text((
                                        response.totalSize / 1024)
                                    .toFixed(2) + ' KB');
                                $('#dir_3_pop')[0]
                                    .reset(); // Reset the form
                                $('#dir_3_pop').find('input[type="file"]')
                                    .each(function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                                    });
                            ...
                            $('#director_DIR_3_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-directdir3-td').text(response.count);
                            $('#total-size-directdir3-td').text((response
                                .totalSize / 1024).toFixed(2) + ' KB');
                            $('#dir_3_pop')[0].reset(); // Reset the form
                            $('#dir_3_pop').find('input[type="file"]').each(
                                function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-count-directdir3-td').text(response.count);
                        $('#total-size-directdir3-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#dir_3_pop')[0].reset(); // Reset the form
        ...
        function fetchdirectorappointmentsdir6Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-directdir6-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#dir_6_pop').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#director_DIR_6_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-directdir6-td').text(
                                    response.count);
                                $('#total-size-directdir6-td').text((
                                        response.totalSize / 1024)
                                    .toFixed(2) + ' KB');
                                $('#dir_6_pop')[0]
                                    .reset(); // Reset the form
                                $('#dir_6_pop').find('input[type="file"]')
                                    .each(function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                                    });
                            ...
                            $('#director_DIR_6_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-directdir6-td').text(response.count);
                            $('#total-size-directdir6-td').text((response
                                .totalSize / 1024).toFixed(2) + ' KB');
                            $('#dir_6_pop')[0].reset(); // Reset the form
                            $('#dir_6_pop').find('input[type="file"]').each(
                                function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-count-directdir6-td').text(response.count);
                        $('#total-size-directdir6-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#dir_6_pop')[0].reset(); // Reset the form
        ...
        function fetchdirectorappointmentsdir12Data() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-directdir12-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
            ...
            $('#dir_12_pop').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#director_DIR_12_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-directdir12-td').text(
                                    response.count);
                                $('#total-size-directdir12-td').text((
                                        response.totalSize / 1024)
                                    .toFixed(2) + ' KB');
                                $('#dir_12_pop')[0]
                                    .reset(); // Reset the form
                                $('#dir_12_pop').find('input[type="file"]')
                                    .each(function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                                    });
                            ...
                            $('#director_DIR_12_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-directdir12-td').text(response.count);
                            $('#total-size-directdir12-td').text((response
                                .totalSize / 1024).toFixed(2) + ' KB');
                            $('#dir_12_pop')[0].reset(); // Reset the form
                            $('#dir_12_pop').find('input[type="file"]').each(
                                function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#entries-count-directdir12-td').text(response.count);
                        $('#total-size-directdir12-td').text((response.totalSize /
                            1024).toFixed(2) + ' KB');
                        $('#dir_12_pop')[0].reset(); // Reset the form
                        $('#dir_12_pop').find('input[type="file"]').each(
                            function() {
        ...
        function fetchcreditcardstatementData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update content inside the <span> with id="total-size-tdsecboard"
                    $('#total-size-crecard-td').text((response.totalSize / 1024).toFixed(2) +
                        ' KB');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#creditcardstatement_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-crecard-td').text(response
                                    .count);
                                $('#total-size-crecard-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#creditcardstatement')[0]
                                    .reset(); // Reset the form
                                $('#creditcardstatement').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#creditcardstatement_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-crecard-td').text(response.count);
                            $('#total-size-crecard-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#creditcardstatement')[0].reset(); // Reset the form
                            $('#creditcardstatement').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#creditcardstatement_pop').modal(
                            'hide'); // Hide the modal
                        $('#entries-count-crecard-td').text(response.count);
                        $('#total-size-crecard-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#creditcardstatement')[0].reset(); // Reset the form
                        $('#creditcardstatement').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
                            ...
                            if (filteredFiles.length === 0) {
                                ...
                                filteredFiles.forEach(file => {
                                    const fileName = file.file_name.split('/')
                                        .pop();
                                    const fileSize = (file.file_size / 1024)
                                        .toFixed(2) + ' KB';
                                    const createdAt = new Date(file.created_at);
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', "#fixeddepositstatementsubmit", function() {
            $('#fixeddepositstatement').on('submit', function(e) {
                ...
                var formData = new FormData(this);
                var submitButton = $(
                    '#fixeddepositstatementsubmit'); // Select the submit button
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#fixeddepositstatement_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-fxdp-td').text(response
                                    .count);
                                $('#total-size-fxdp-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#fixeddepositstatement')[0]
                                    .reset(); // Reset the form
                                $('#fixeddepositstatement').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#fixeddepositstatement_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-fxdp-td').text(response.count);
                            $('#total-size-fxdp-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#fixeddepositstatement')[0]
                                .reset(); // Reset the form
                            $('#fixeddepositstatement').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#fixeddepositstatement_pop').modal(
                            'hide'); // Hide the modal
                        $('#entries-count-fxdp-td').text(response.count);
                        $('#total-size-fxdp-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#fixeddepositstatement')[0].reset(); // Reset the form
                        $('#fixeddepositstatement').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#mutualfundstatement_pop').modal(
                                    'hide'); // Hide the modal
                                $('#entries-count-mufund-td').text(response
                                    .count);
                                $('#total-size-mufund-td').text((response
                                        .totalSize / 1024).toFixed(2) +
                                    ' KB');
                                $('#mutualfundstatement')[0]
                                    .reset(); // Reset the form
                                $('#mutualfundstatement').find(
                                    'input[type="file"]').each(
                                    function() {
                                        resetFileInput($(
                                            this)); // Reset file inputs
                            ...
                            $('#mutualfundstatement_pop').modal(
                                'hide'); // Hide the modal
                            $('#entries-count-mufund-td').text(response.count);
                            $('#total-size-mufund-td').text((response.totalSize /
                                1024).toFixed(2) + ' KB');
                            $('#mutualfundstatement')[0].reset(); // Reset the form
                            $('#mutualfundstatement').find('input[type="file"]')
                                .each(function() {
                                    resetFileInput($(
                                        this)); // Reset file inputs
                                });
                    ...
                    error: function() {
                        ...
                        $('#mutualfundstatement_pop').modal(
                            'hide'); // Hide the modal
                        $('#entries-count-mufund-td').text(response.count);
                        $('#total-size-mufund-td').text((response.totalSize / 1024)
                            .toFixed(2) + ' KB');
                        $('#mutualfundstatement')[0].reset(); // Reset the form
                        $('#mutualfundstatement').find('input[type="file"]').each(
                            function() {
                                resetFileInput($(this)); // Reset file inputs
                            });
                        clearSelectedFile(); // Clear selected file div
                ...
                success: function(response) {
                    ...
                    if (response && Array.isArray(response.files) && response.files.length > 0) {
                        ...
                        response.files.forEach(file => {
                            ...
                            let fileSize;
                            const dataTags = JSON.parse(file
                                .tags); // Parse JSON string into a JavaScript array
                            const formattedTags = dataTags.join(
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 302) {
                        ...
                        toastr.error(
                            'Failed to download file.'); // Display error toaster message
