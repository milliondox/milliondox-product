<div class="custom_table_wraap nestfile" >
    ...
    <tr class="">
                          ...
                          <td>Form DPT-3</td>                                                              
                             <td><span class="comm_size" id="total-size-dirdpt3s-td" data-variable="totalSizeKBdepositundertakingsFormDPT3"> {{$totalSizeKBdepositundertakingsFormDPT3}}  KB</span> </td>
                              <td> 
                            <div class="type_number getparm" data-location="" data-bs-toggle="modal" data-real_file_name="Form DPT-3" data-bs-target="#StautoryReg_ballot_count" id="StautoryReg_ballot_countt">
...
<span class="cpoont"><span class="comm_count" id="entries-count-dirdpt3s-td" data-variable="countdepositundertakingsFormDPT3"> {{$countdepositundertakingsFormDPT3}} </span></span>
                            </div>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice getparm" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#common_file_upload_pop" data-location="" data-real-file-name="Form DPT-3">
...
<td>
           ...
           <!-- repeat me start -->
                                  ...
                                  <!-- upload file model start  Undertakings_dpt_3_pop-->
<div class="modal fade drop_coman_file have_title" id="Undertakings_dpt_3_pop" tabindex="-1" role="dialog" aria-labelledby="Undertakings_dpt_3_pop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>Upload File</h3>
                <form id="Undertakings_dpt_3s" action="{{ route('depositundertakingsFormDPT3') }}" method="POST" enctype="multipart/form-data">
   ...
   <div class="gropu_form">
    ...
    <div class="file-area_cover"> 
                          ...
                          <input type="file" class="dragfile" id="file" name="files[]" multiple  required> 
                           <input type="hidden" id="real_file_name" name="real_file_name" value="Form DPT 3">
                            <input type="hidden" id="location" name="location" value="Legal / Secretarial / Deposit Undertakings">
        ...
        <label for="desc">Description (Optional)</label>
         <div class="tag-container">
            <textarea name="desc" placeholder="Description" style="height: 68px;"></textarea>
                    ...
                    <div class="upp_input">
                    <button class="btn btn-primary" style="border-radius:5px;" id="Undertakings_dpt_3_submits" disabled type="submit">Upload</button>
</div>
                </form>
            </div>
        </div>
...
<!-- data show table model satrt Undertakings_dpt_3_count-->
    <div class="modal fade drop_coman_file have_title borde_show_fulll_data" id="Undertakings_dpt_3_count" tabindex="-1" role="dialog" aria-labelledby="Undertakings_dpt_3_count" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700">Form DPT-3</h5>
                    <button class="close" style="border-radius:5px;" type="button" data-bs-dismiss="modal">
                        <span aria-hidden="true">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="4.27093" height="66.172" transform="matrix(0.702074 -0.712104 0.709324 0.704883 0 3.31244)" fill="black" />
...
<div class="retreve_inn_sec"> 
    ...
    <a href="{{ url("/showAdvSearch") }}?category=Secretarial&section=Deposit Undertakings&subsection=Form DPT-3" id="load-notices-btn">TRY OUT
    ...
    <path d="M0.666341 5L11.333 5M11.333 5L7.33301 9M11.333 5L7.33301 1" stroke="#CEFFA8" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="modal-body">
                    ...
                    <div class="custom_table_wraap">
                        <table class="table table-striped display" style="width:100%" id="filesTabledirdpt3">
                            <thead>
                                <tr>
