    ...
    <tr class="">
                          ...
                          <td>Form DPT-3</td>                                                              
                             <td><span id="total-size-dirdpt3s-td"> {{$totalSizeKBdepositundertakingsFormDPT3}}  KB</span> </td>
                              <td> 
                            <div class="type_number" data-bs-toggle="modal" data-bs-target="#Undertakings_dpt_3_count" id="Undertakings_dpt_3_countt">
...
<span class="cpoont"><span id="entries-count-dirdpt3s-td"> {{$countdepositundertakingsFormDPT3}} </span></span>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#Undertakings_dpt_3_pop">
