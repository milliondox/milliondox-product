<div class="custom_table_wraap nestfile" >
    ...
    <tr class="">
                          ...
                          <td>Form DPT-3</td>                                                              
                             <td><span class="comm_size" id="total-size-dirdpt3s-td"> {{$totalSizeKBdepositundertakingsFormDPT3}}  KB</span> </td>
                              <td> 
...
<span class="cpoont"><span class="comm_count" id="entries-count-dirdpt3s-td"> {{$countdepositundertakingsFormDPT3}} </span></span>
                            </div>
