    ...
    <tr class="" >
                          ...
                          <td>Fixed Deposit Account Statement</td>
                            <td><span id="total-size-fxdp-td"> {{$totalSizeKBfixeddepoiststatement}} KB</span> </td>
                              <td> 
                            <div class="type_number" data-bs-toggle="modal" data-bs-target="#fixeddepositstatement_count"  id="fixeddepositstatement_countt">
...
<span class="cpoont"><span id="entries-count-fxdp-td">{{$countfixeddepoiststatement}} </span></span>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#fixeddepositstatement_pop">
