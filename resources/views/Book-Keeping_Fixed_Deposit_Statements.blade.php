 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Fixed Deposit Account Statement</td>
                            <td><span class="comm_size" id="total-size-fxdp-td"> {{$totalSizeKBfixeddepoiststatement}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span class="comm_count" id="entries-count-fxdp-td">{{$countfixeddepoiststatement}} </span></span>
                            </div>
