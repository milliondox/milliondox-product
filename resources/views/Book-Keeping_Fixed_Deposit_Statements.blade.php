 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Fixed Deposit Account Statement</td>
                            <td><span id="total-size-fxdp-td"> {{$totalSizeKBfixeddepoiststatement}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span id="entries-count-fxdp-td">{{$countfixeddepoiststatement}} </span></span>
                            </div>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice getparm" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#common_file_upload_pop" data-location="" data-real-file-name="Fixed Deposit Account Statement">
