        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{url('/admin/announcement')}}"><i data-feather="radio"> </i><span>Announcements</span></a></li>
                 ...
                 <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{url('/admin/template')}}"><i data-feather="file"> </i><span>Template</span></a></li>
