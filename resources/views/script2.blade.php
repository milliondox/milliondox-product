...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents script start -->
<script>
$(document).ready(function() {

    function fetchhremponboardFileData(location) {

        $.ajax({
            url: '{{ route('fetch-hremponboard-file-data') }}',
            type: 'GET',
            data: { location: location }, // Pass the location parameter
            success: function(response) {
                if (response && Array.isArray(response.files)) {
                    const tableBody = $('#filesTableboardhrempoofer tbody');
                    tableBody.empty();
 ...
 <rect width="13" height="12" fill="white"/>
         ...
         <button type="button" class="delete-button" id="delbtdtst73222" data-unique_tb_id="${file.id}">
                                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <path d="M5.07536 13.3334C4.77759 13.3334 4.52359 13.2285 4.31336 13.0187C4.10359 12.809 3.9987 12.555 3.9987 12.2567V4.00007H3.33203V3.3334H5.9987V2.82007H9.9987V3.3334H12.6654V4.00007H11.9987V12.2567C11.9987 12.5634 11.896 12.8194 11.6907 13.0247C11.4849 13.2305 11.2287 13.3334 10.922 13.3334H5.07536ZM11.332 4.00007H4.66536V12.2567C4.66536 12.3763 4.70381 12.4745 4.7807 12.5514C4.85759 12.6283 4.95581 12.6667 5.07536 12.6667H10.922C11.0243 12.6667 11.1183 12.6241 11.204 12.5387C11.2894 12.453 11.332 12.359 11.332 12.2567V4.00007ZM6.53736 11.3334H7.20403V5.3334H6.53736V11.3334ZM8.79337 11.3334H9.46003V5.3334H8.79337V11.3334Z" fill="#FA4A4A"></path>
                                    </svg> 
                                                            </button> 
...
function toggleMoveToDataRoomButton() {
    ...
    $('body').on('click', '#Offer_Letter_countt', function() {
        const location  = $(this).data('location');
        fetchhremponboardFileData(location );
        });
        fetchhremponboardFileData(location);
...
<script>
    ...
    $(document).ready(function() {
        // When the delete button is clicked
        $(document).on('click', '#delbtdtst73222', function() {
            var id = $(this).data('unique_tb_id'); 
            var button = $(this);
...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents script end -->



<!-- Human Resources /mega mart /Employee Database /Onboarding documents Acceptance Letter script start -->
<script>
$(document).ready(function() {

    function fetchhremponboardalFileData(location) {

        $.ajax({
            url: '{{ route('fetch-hremponboardal-file-data') }}',
            type: 'GET',
            data: { location: location }, // Pass the location parameter
            success: function(response) {
                if (response && Array.isArray(response.files)) {
                    const tableBody = $('#filesTableboardemponboardal tbody');
                    tableBody.empty();
...
function toggleMoveToDataRoomButton() {
    ...
    $('body').on('click', '#Acceptance_Letter_countt', function() {
        const location  = $(this).data('location');
        fetchhremponboardalFileData(location );
        });
        fetchhremponboardalFileData(location);
...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents Acceptance Letter script end -->
...
$(document).ready(function() {
    ...
    function fetchhremponboardeaFileData(location) {

        $.ajax({
            url: '{{ route('fetch-hremponboardea-file-data') }}',
            type: 'GET',
            data: { location: location }, // Pass the location parameter
            success: function(response) {
                if (response && Array.isArray(response.files)) {
                    const tableBody = $('#filesTableemponboardea tbody');
                    tableBody.empty();
...
function toggleMoveToDataRoomButton() {
    ...
    $('body').on('click', '#Employment_Agreement_countt', function() {
        const location  = $(this).data('location');
        fetchhremponboardeaFileData(location );
        });
        fetchhremponboardeaFileData(location);
...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents Employment Agreement script end -->


<!-- Human Resources /mega mart /Employee Database /Onboarding documents Non Disclosure Agreement script start -->
<script>
$(document).ready(function() {

    function fetchhremponboardndaFileData(location) {

        $.ajax({
            url: '{{ route('fetch-hremponboardnda-file-data') }}',
            type: 'GET',
            data: { location: location }, // Pass the location parameter
            success: function(response) {
                if (response && Array.isArray(response.files)) {
                    const tableBody = $('#filesTableemponboardnda tbody');
                    tableBody.empty();
...
function toggleMoveToDataRoomButton() {
    ...
    $('body').on('click', '#Non_Disclosure_Agreement_countt', function() {
        const location  = $(this).data('location');
        fetchhremponboardndaFileData(location );
        });
        fetchhremponboardndaFileData(location);
...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents Non Disclosure Agreement script end -->


<!-- Human Resources /mega mart /Employee Database /Onboarding documents Non-compete script start -->
<script>
$(document).ready(function() {

    function fetchhremponboardncFileData(location) {

        $.ajax({
            url: '{{ route('fetch-hremponboardnc-file-data') }}',
            type: 'GET',
            data: { location: location }, // Pass the location parameter
            success: function(response) {
                if (response && Array.isArray(response.files)) {
                    const tableBody = $('#filesTableemponboardnc tbody');
                    tableBody.empty();
...
function toggleMoveToDataRoomButton() {
    ...
    $('body').on('click', '#Non_compete_countt', function() {
        const location  = $(this).data('location');
        fetchhremponboardncFileData(location );
        });
        fetchhremponboardncFileData(location);
...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents Non-compete script end -->



<!-- Human Resources /mega mart /Employee Database /Onboarding documents Contractual Bond script start -->
<script>
$(document).ready(function() {

    function fetchhremponboardcbFileData(location) {

        $.ajax({
            url: '{{ route('fetch-hremponboardcb-file-data') }}',
            type: 'GET',
            data: { location: location }, // Pass the location parameter
            success: function(response) {
                if (response && Array.isArray(response.files)) {
                    const tableBody = $('#filesTableemponboardcb tbody');
                    tableBody.empty();
...
function toggleMoveToDataRoomButton() {
    ...
    $('body').on('click', '#Contractual_Bond_countt', function() {
        const location  = $(this).data('location');
        fetchhremponboardcbFileData(location );
        });
        fetchhremponboardcbFileData(location);
...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents Contractual Bond script end -->


<!-- Human Resources /mega mart /Employee Database /Onboarding documents Form 11 - EPF script start -->
<script>
$(document).ready(function() {

    function fetchhremponboardepfFileData(location) {

        $.ajax({
            url: '{{ route('fetch-hremponboardepf-file-data') }}',
            type: 'GET',
            data: { location: location }, // Pass the location parameter
            success: function(response) {
                if (response && Array.isArray(response.files)) {
                    const tableBody = $('#filesTableemponboardepf tbody');
                    tableBody.empty();
...
function toggleMoveToDataRoomButton() {
    ...
    $('body').on('click', '#Form_11_EPF_countt', function() {
        const location  = $(this).data('location');
        fetchhremponboardepfFileData(location );
        });
        fetchhremponboardepfFileData(location);
...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents Form 11 - EPF script end -->


<!-- Human Resources /mega mart /Employee Database /Onboarding documents Form 12BB - Income Tax script start -->
<script>
$(document).ready(function() {

    function fetchhremponboardincometaxFileData(location) {

        $.ajax({
            url: '{{ route('fetch-hremponboardincometax-file-data') }}',
            type: 'GET',
            data: { location: location }, // Pass the location parameter
            success: function(response) {
                if (response && Array.isArray(response.files)) {
                    const tableBody = $('#filesTableemponboardincometax tbody');
                    tableBody.empty();
...
function toggleMoveToDataRoomButton() {
    ...
    $('body').on('click', '#Form_12BB_Income_Tax_countt', function() {
        const location  = $(this).data('location');
        fetchhremponboardincometaxFileData(location );
        });
        fetchhremponboardincometaxFileData(location);
...
<!-- Human Resources /mega mart /Employee Database /Onboarding documents Form 12BB - Income Tax script end -->