    ...
    <tr class="" >
                          ...
                          <td>Add Mutual Fund Statements</td>
                            <td><span id="total-size-mufund-td">{{$totalSizeKBmutualfundstatement}} KB</span> </td>
                              <td> 
                            <div class="type_number" data-bs-toggle="modal" data-bs-target="#mutualfundstatement_count" id="mutualfundstatement_countt">
...
<span class="cpoont"><span id="entries-count-mufund-td">{{$countmutualfundstatement}}</span></span>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#mutualfundstatement_pop">
