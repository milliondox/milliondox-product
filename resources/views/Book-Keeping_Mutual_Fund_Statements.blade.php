 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Add Mutual Fund Statements</td>
                            <td><span class="comm_size" id="total-size-mufund-td">{{$totalSizeKBmutualfundstatement}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span class="comm_count" id="entries-count-mufund-td">{{$countmutualfundstatement}}</span></span>
                            </div>
