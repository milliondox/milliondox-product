 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Add Mutual Fund Statements</td>
                            <td><span class="comm_size" id="total-size-mufund-td" data-variable="totalSizeKBmutualfundstatement">{{$totalSizeKBmutualfundstatement}} KB</span> </td>
                              <td> 
                            <div class="type_number getparm" data-location="" data-bs-toggle="modal" data-bs-target="#mutualfundstatement_count" id="mutualfundstatement_countt">
...
<span class="cpoont"><span class="comm_count" id="entries-count-mufund-td" data-variable="countmutualfundstatement">{{$countmutualfundstatement}}</span></span>
                            </div>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice getparm" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#common_file_upload_pop_bank" data-location="" data-real-file-name="Add Mutual Fund Statements">
...
<td>
         ...
         <!-- repeat me start -->
                                  ...
                                  <!-- upload file model start  mutualfundstatement_pop-->
<div class="modal fade drop_coman_file have_title" id="mutualfundstatement_pop" tabindex="-1" role="dialog" aria-labelledby="mutualfundstatement_pop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>Upload File</h3>
                <form id="mutualfundstatement" action="{{ route('mutualfundstatement') }}" method="POST" enctype="multipart/form-data">
 ...
 <div class="file-area_cover"> 
                          ...
                          <input type="file" class="dragfile" id="file" name="files[]" multiple  required> 
                           <input type="hidden" id="real_file_name" name="real_file_name" value="Add Mutual Fund Statements">
                           <input type="hidden" id="location" name="location" value="Accounting & Taxation / Book-Keeping / Mutual Fund Statements">
        ...
        <label for="desc">Description (Optional)</label>
         <div class="tag-container">
            <textarea name="desc" placeholder="Description" style="height: 68px;"></textarea>
                    ...
                    <div class="upp_input">
                    <button class="btn btn-primary" style="border-radius:5px;" id="mutualfundstatementsubmit" disabled type="submit">Upload</button>
</div>
                </form>
            </div>
        </div>
...
<!-- data show table model satrt mutualfundstatement_count-->
    <div class="modal fade drop_coman_file have_title borde_show_fulll_data" id="mutualfundstatement_count" tabindex="-1" role="dialog" aria-labelledby="mutualfundstatement_count" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700">Add Mutual Fund Statements</h5>
                    <button class="close" style="border-radius:5px;" type="button" data-bs-dismiss="modal">
                        <span aria-hidden="true">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="4.27093" height="66.172" transform="matrix(0.702074 -0.712104 0.709324 0.704883 0 3.31244)" fill="black" />
...
<div class="retreve_inn_sec"> 
    ...
    <a href="{{ url("/showAdvSearch") }}?category=Accounting Taxation&section=Mutual Fund Statements&subsection=Add Mutual Fund Statements" id="load-notices-btn">TRY OUT
    ...
    <path d="M0.666341 5L11.333 5M11.333 5L7.33301 9M11.333 5L7.33301 1" stroke="#CEFFA8" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="modal-body">
                    <h3>Add Mutual Fund Statements</h3>
                    	                    <div class="filter_table_bank">
                <div class="gropu_form">
        <select id="choose_bankmf" name="choose_bank" required="">
             <option value="ABBank">Allahabad Bank</option>
    <option value="AndhraBank">Andhra Bank</option>
    <option value="AxisBank">Axis Bank Limited</option>
    <option value="BandhanBank">Bandhan Bank Limited</option>
    ...
    <option value="YesBank">Yes Bank Limited</option>
                    ...
                    <div class="custom_table_wraap">
                        <table class="table table-striped display" style="width:100%" id="filesTablemufund">
                            <thead>
                                <tr>
