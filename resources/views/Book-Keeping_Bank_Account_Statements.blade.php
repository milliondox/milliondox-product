    ...
    <tr class="" >
                          ...
                          <td>Bank Account Statement</td>
                            <td><span id="total-sizebankstatement-td">{{$totalSizeKBbank}} KB</span> </td>
                              <td> 
                            <div class="type_number" data-bs-toggle="modal" data-bs-target="#bankaccstatement_count" id="bankaccstatement_countt">
...
<span class="cpoont"><span id="entries-countbankstatement-td">{{$countbank}}</span></span>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#bankaccstatement_pop">
