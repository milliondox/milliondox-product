 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Bank Account Statement</td>
                            <td><span class="comm_size" id="total-sizebankstatement-td">{{$totalSizeKBbank}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span class="comm_count" id="entries-countbankstatement-td">{{$countbank}}</span></span>
                            </div>
