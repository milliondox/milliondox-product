 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Bank Account Statement</td>
                            <td><span id="total-sizebankstatement-td">{{$totalSizeKBbank}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span id="entries-countbankstatement-td">{{$countbank}}</span></span>
                            </div>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice getparm" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#common_file_upload_pop" data-location="" data-real-file-name="Bank Account Statement">
