 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Bank Account Statement</td>
                            <td><span class="comm_size" id="total-sizebankstatement-td" data-variable="totalSizeKBbank">{{$totalSizeKBbank}} KB</span> </td>
                              <td> 
                            <div class="type_number getparm" data-location="" data-bs-toggle="modal" data-bs-target="#bankaccstatement_count" id="bankaccstatement_countt">
...
<span class="cpoont"><span class="comm_count" id="entries-countbankstatement-td" data-variable="countbank">{{$countbank}}</span></span>
                            </div>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice getparm" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#common_file_upload_pop_bank" data-location="" data-real-file-name="Bank Account Statement">
...
<td>
         ...
         <!-- repeat me start -->
                                  ...
                                  <!-- upload file model start  bankaccstatement_pop-->
<div class="modal fade drop_coman_file have_title" id="bankaccstatement_pop" tabindex="-1" role="dialog" aria-labelledby="bankaccstatement_pop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>Upload File</h3>
                <form id="bankaccstatement" action="{{ route('bankaccountstatement') }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="file-area_cover"> 
                          ...
                          <input type="file" class="dragfile" id="file" name="files[]" multiple  required> 
                           <input type="hidden" id="real_file_name" name="real_file_name" value="Bank account statement">
                            <input type="hidden" id="location" name="location" value="Accounting & Taxation / Book-Keeping / Bank Account Statements">
        ...
        <label for="desc">Description (Optional)</label>
         <div class="tag-container">
            <textarea name="desc" placeholder="Description" style="height: 68px;"></textarea>
                    ...
                    <div class="upp_input">
                    <button class="btn btn-primary" style="border-radius:5px;" id="bankaccstatementsubmit" disabled type="submit">Upload</button>
</div>
                </form>
            </div>
        </div>
...
<!-- data show table model satrt bankaccstatement_count-->
    <div class="modal fade drop_coman_file have_title borde_show_fulll_data" id="bankaccstatement_count" tabindex="-1" role="dialog" aria-labelledby="bankaccstatement_count" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700">Bank Account Statement</h5>
                    <button class="close" style="border-radius:5px;" type="button" data-bs-dismiss="modal">
                        <span aria-hidden="true">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="4.27093" height="66.172" transform="matrix(0.702074 -0.712104 0.709324 0.704883 0 3.31244)" fill="black" />
...
<div class="retreve_inn_sec"> 
    ...
    <a href="{{ url("/showAdvSearch") }}?category=Accounting Taxation&section=Bank Account Statements&subsection=Bank Account Statement" id="load-notices-btn">TRY OUT
    ...
    <path d="M0.666341 5L11.333 5M11.333 5L7.33301 9M11.333 5L7.33301 1" stroke="#CEFFA8" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="gropu_form">
                <select id="choose_bank" class="choose_bank" name="bank_name"  >
    <option value="" disabled="" selected="">Select Bank</option>
    <option value="ABBank">Allahabad Bank</option>
    <option value="AndhraBank">Andhra Bank</option>
    <option value="AxisBank">Axis Bank Limited</option>
    ...
    <option value="YesBank">Yes Bank Limited</option>
                    ...
                    <div class="custom_table_wraap" style="display: none;">
                        <table class="table table-striped display " style="width:100%" id="filesTablebankaccount">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Bank Name</th>
