 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>DIR-11 form</td>
                            <td><span id="total-size-directresi11-td"> {{$totalSizeKBdirectorresignationdir11}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span id="entries-count-directresi11-td"> {{$countdirectorresignationdir11}} </span></span>
                            </div>
...
<td>
           ...
           <tr class="" >
                          ...
                          <td>DIR-12 form</td>
                           <td><span id="total-size-directresi12-td">{{$totalSizeKBdirectorresignationdir12}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span id="entries-count-directresi12-td"> {{$countdirectorresignationdir12}} </span></span>
                            </div>
