 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Add Credit Card Statements</td>
                            <td><span class="comm_size" id="total-size-crecard-td">{{$totalSizeKBcreditcardstatement}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span class="comm_count" id="entries-count-crecard-td"> {{$countdcreditcardstatement}} </span></span>
                            </div>
