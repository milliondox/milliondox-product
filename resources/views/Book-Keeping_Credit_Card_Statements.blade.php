    ...
    <tr class="" >
                          ...
                          <td>Add Credit Card Statements</td>
                            <td><span id="total-size-crecard-td">{{$totalSizeKBcreditcardstatement}} KB</span> </td>
                              <td> 
                            <div class="type_number" data-bs-toggle="modal" data-bs-target="#creditcardstatement_count" id="creditcardstatement_countt">
...
<span class="cpoont"><span id="entries-count-crecard-td"> {{$countdcreditcardstatement}} </span></span>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#creditcardstatement_pop">
