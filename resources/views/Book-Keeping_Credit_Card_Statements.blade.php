 <div class="custom_table_wraap nestfile">
       ...
       <span><b>1 path available</b></span>
        </div>
    ...
    <tr class="" >
                          ...
                          <td>Add Credit Card Statements</td>
                            <td><span class="comm_size" id="total-size-crecard-td" data-variable="totalSizeKBcreditcardstatement">{{$totalSizeKBcreditcardstatement}} KB</span> </td>
                              <td> 
                            <div class="type_number getparm" data-location="" data-bs-toggle="modal" data-bs-target="#creditcardstatement_count" id="creditcardstatement_countt">
...
<span class="cpoont"><span class="comm_count" id="entries-count-crecard-td" data-variable="countdcreditcardstatement"> {{$countdcreditcardstatement}} </span></span>
                            </div>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice getparm" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#common_file_upload_pop_bank" data-location="" data-real-file-name="Add Credit Card Statements">
...
<td>
         ...
         <!-- repeat me start -->
                                  ...
                                  <!-- upload file model start  creditcardstatement_pop-->
<div class="modal fade drop_coman_file have_title" id="creditcardstatement_pop" tabindex="-1" role="dialog" aria-labelledby="creditcardstatement_pop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>Upload File</h3>
                <form id="creditcardstatement" action="{{ route('creditcardstatement') }}" method="POST" enctype="multipart/form-data">
...
<div class="file-area_cover"> 
                          ...
                          <input type="file" class="dragfile" id="file" name="files[]" multiple  required> 
                           <input type="hidden" id="real_file_name" name="real_file_name" value="Add Credit Card Statements">
                           <input type="hidden" id="location" name="location" value="Accounting & Taxation / Book-Keeping / Credit Card Statements">
        ...
        <label for="desc">Description (Optional)</label>
         <div class="tag-container">
            <textarea name="desc" placeholder="Description" style="height: 68px;"></textarea>
                    ...
                    <div class="upp_input">
                    <button class="btn btn-primary" style="border-radius:5px;" id="creditcardstatementsubmit"  disabled type="submit">Upload</button>
</div>
                </form>
            </div>
        </div>
...
<!-- data show table model satrt creditcardstatement_count-->
    <div class="modal fade drop_coman_file have_title borde_show_fulll_data" id="creditcardstatement_count" tabindex="-1" role="dialog" aria-labelledby="creditcardstatement_count" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700">Add Credit Card Statements</h5>
                    <button class="close" style="border-radius:5px;" type="button" data-bs-dismiss="modal">
                        <span aria-hidden="true">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="4.27093" height="66.172" transform="matrix(0.702074 -0.712104 0.709324 0.704883 0 3.31244)" fill="black" />
...
<div class="retreve_inn_sec"> 
    ...
    <a href="{{ url("/showAdvSearch") }}?category=Accounting Taxation&section=Credit Card Statements&subsection=Add Credit Card Statements" id="load-notices-btn">TRY OUT
    ...
    <path d="M0.666341 5L11.333 5M11.333 5L7.33301 9M11.333 5L7.33301 1" stroke="#CEFFA8" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="modal-body">
                    <h3>Add Credit Card Statements</h3>
                    	                    <div class="filter_table_bank">
                <div class="gropu_form">
           <select id="choose_bank22" class="choose_bank1" data-selecttype="ccs" name="bank_name"  >
    <option value="" disabled="" selected="">Select Bank</option>
    <option value="ABBank">Allahabad Bank</option>
    <option value="AndhraBank">Andhra Bank</option>
    <option value="AxisBank">Axis Bank Limited</option>
    ...
    <option value="YesBank">Yes Bank Limited</option>
                    ...
                    <div class="custom_table_wraap" style="display: none;">
                        <table class="table table-striped display " style="width:100%" id="filesTablecrecard">
                            <thead>
                                <tr>
                    ...
                    <div class="khaliclass" ><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <p>No data found, please select the Bank first.</p>
                              </div>
                </div>
            </div>
        </div>
