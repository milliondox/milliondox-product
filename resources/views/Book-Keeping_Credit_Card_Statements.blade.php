 <div class="custom_table_wraap nestfile">
    ...
    <tr class="" >
                          ...
                          <td>Add Credit Card Statements</td>
                            <td><span id="total-size-crecard-td">{{$totalSizeKBcreditcardstatement}} KB</span> </td>
                              <td> 
...
<span class="cpoont"><span id="entries-count-crecard-td"> {{$countdcreditcardstatement}} </span></span>
                            </div>
                          ...
                          <td>
                            ...
                            <button class="btndd hidebdnotice getparm" style="border-radius:5px;"   data-bs-toggle="modal" data-bs-target="#common_file_upload_pop" data-location="" data-real-file-name="Add Credit Card Statements">
