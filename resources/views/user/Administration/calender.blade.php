@extends('user.includes.calender') @section('content')
    <!-- tap on top starts-->
        ...
        <div class="page-body">
          ...
          <div class="mlb-menu-header container-fluid" style="display:none;">
           ...
           Calender
             ...
             <div class="container-fluid calnder_event_nt">
...
<!-- <div class="for_group radio">
    ...
    <div class="for_group an_re">
        <button type="button" class="event-type-btn"  name="eventType"  value="Anniversary" data-value="anniversary">Anniversary</button>
    ...
    <div class="for_group bttn">
      ...
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.6667 12.6667V5.33341H3.33333V12.6667H12.6667ZM10.6667 0.666748H12V2.00008H12.6667C13.0203 2.00008 13.3594 2.14056 13.6095 2.39061C13.8595 2.64065 14 2.97979 14 3.33341V12.6667C14 13.4067 13.4067 14.0001 12.6667 14.0001H3.33333C2.97971 14.0001 2.64057 13.8596 2.39052 13.6096C2.14048 13.3595 2 13.0204 2 12.6667V3.33341C2 2.59341 2.59333 2.00008 3.33333 2.00008H4V0.666748H5.33333V2.00008H10.6667V0.666748ZM7.33333 6.33341H8.66667V8.33341H10.6667V9.66675H8.66667V11.6667H7.33333V9.66675H5.33333V8.33341H7.33333V6.33341Z" fill="white"/>
</svg>  
      Add</button>    
    </div>
</form>
