        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-body">
                ...
                @if (isset($user->video_status) && $user->video_status == '0')
                    <button class="btn_command " style="border-radius:5px; display:none;" data-bs-toggle="modal"
                        data-bs-target="#aniation_dash">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M8.25 12V5.8875L6.3 7.8375L5.25 6.75L9 3L12.75 6.75L11.7 7.8375L9.75 5.8875V12H8.25ZM4.5 15C4.0875 15 3.7345 14.8533 3.441 14.5597C3.1475 14.2662 3.0005 13.913 3 13.5V11.25H4.5V13.5H13.5V11.25H15V13.5C15 13.9125 14.8533 14.2657 14.5597 14.5597C14.2662 14.8538 13.913 15.0005 13.5 15H4.5Z"
                                fill="#7E7E7E" />
                        </svg> Upload </button>
                    <div class="modal fade show" id="aniation_dash" tabindex="-1" role="dialog"
                        aria-labelledby="aniation_dash" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                        ...
                                        <span aria-hidden="true">
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                ...
                                                <rect width="4.27093" height="66.172"
                                                    transform="matrix(0.702074 -0.712104 0.709324 0.704883 0 3.31244)"
                                                    fill="black" />
                                                <rect width="4.27086" height="66.3713"
                                                    transform="matrix(-0.704896 -0.70931 0.706518 -0.707695 3.10742 50)"
                                                    fill="black" />
                                            </svg>
                                        </span>
                                    </button>
                                ...
                                <div class="modal-body">
                                    ...
                                    <iframe width="1903" height="784"
                                        src="https://www.youtube.com/embed/NqWP-pl1CfQ?autoplay=1&mute=1&loop=1&playlist=NqWP-pl1CfQ&modestbranding=1&showinfo=0&controls=0"
                            ...
                            <div class="Inc_table">
                                ...
                                <div class=" tba_history_rap">
                                    ...
                                    <div class="filtr_tabble">
                                        <div class="tab">
                                            <button class="tablinks" onclick="openTab(event, 'roleManagement')" id="defaultOpen">Role Management</button>
                                            <button class="tablinks" onclick="openTab(event, 'divisionManagement')">Division Management</button>
                                            <button class="tablinks" onclick="openTab(event, 'authorizeManagement')">Authorize Management</button>
                                        </div>
                                                        ...
                                                        <div class="left_management">
                                                            ...
                                                            <div class="bottom_ad_role">
                                                                <div class="sadd_filds">
                                                                    <button class="hvr-rotate" data-bs-toggle="modal"
                                                                        data-bs-target="#role_namee">+ Add a role</button>
                                                                </div>
                                                            </div>
                                                            <!-- model start -->
                                                            <div class="modal fade drop_coman_file have_title" id="role_namee"
                                                                tabindex="-1" role="dialog" aria-labelledby="role_namee"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" style="font-weight:700">
                                                                                Add Role Name</h5>
                                                                            <button class="close" style="border-radius:5px;"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <form action="{{ route('addroles') }}"
                                                                                method="POST" enctype="multipart/form-data"
                                                                                class="upload-form" id="roleForm">
                                                                                @csrf
                                                                                <div class="gropu_form">
                                                                    ...
                                                                    <div id="tab1{{ $role->id }}" class="tabcontentdd">
                                                                        <div class="tabs">
                                                                            ...
                                                                            <button class="tab-link active"
                                                                                onclick="openTabbb('dsc{{ $role->id }}')">Permissions</button>
                                                                            <button class="tab-link"
                                                                                onclick="openTabbb('dsc1{{ $role->id }}')">Members</button>
                                                                        </div>
                                                                                    ...
                                                                                    <div class="main_tep">
                                                                                        ...
                                                                                        <div class="left_fav">
                                                                                            <a class="hvr-rotate"
                                                                                                ...
                                                                                                data-bs-target="#add_member{{ $role->id }}">Add
                                                                                                Members</a>
                                                                                        </div>
    
                                                                                        <!-- model start -->
                                                                                        <div class="modal fade drop_coman_file have_title"
                                                                                            id="add_member{{ $role->id }}"
                                                                                            tabindex="-1" role="dialog"
                                                                                            aria-labelledby="add_member{{ $role->id }}"
                                                                                            aria-hidden="true">
                                                                                            <div class="modal-dialog modal-dialog-centered"
                                                                                                ...
                                                                                                <div class="modal-content">
                                                                                                    ...
                                                                                                    <div class="modal-body">
                                                                                                        ...
                                                                                                        <form id="memberForm"
                                                                                                            action="{{ route('members') }}"
                                                                                                            method="POST"
                                                                                                            enctype="multipart/form-data"
                                                                                                            class="upload-form">
                                                                                                            @csrf
                                                                                                            <div
                                                                                                                class="gropu_form ivoice-upload">
                                                                                                                <label
                                                                                                                    for="profile_picture">Employee
                                                                                                                    Picture*</label>
                                                                                                                <div class="file-area"
                                                                                                                    id="round_uplad_image">
                                                                                                                    <div
                                                                                                                        class="inner_file_edit">
                                                                                                                        <input
                                                                                                                            type="file"
                                                                                                                            id="emppicd"
                                                                                                                            class="emppicd"
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        ...
                                                                                                                        style="display: block; margin-top: 5px; color: red;"></span>
                                                                                                                    <b
                                                                                                                        class="toggle-password"><i
                                                                                                                            class="fas fa-eye-slash"></i></b>
                                                                                                                </div>
                                                                                                            </div>
                                                                                        ...
                                                                                        input.addEventListener('change', function(event) {
                                                                                            ...
                                                                                            if (file) {
                                                                                                ...
                                                                                                reader.onload = function(e) {
                                                                                                    ...
                                                                                                    const previewImg = event.target.closest('.inner_file_edit').querySelector(
                                                                                                        '.previewd');
                                                                                                    if (previewImg) {
                                                        ...
                                                        @else
                                                            <div class="gerneal_emptty">
                                                                <svg width="15" height="15" viewBox="0 0 15 15"
                                                                    ...
                                                                    <path
                                                                        d="M7.0277 8.93L6.9077 4H8.0477L7.9277 8.93H7.0277ZM7.5077 11.06C7.30103 11.06 7.13103 10.9967 6.9977 10.87C6.87103 10.7367 6.8077 10.58 6.8077 10.4C6.8077 10.2133 6.87103 10.0567 6.9977 9.93C7.13103 9.79667 7.30103 9.73 7.5077 9.73C7.70103 9.73 7.86103 9.79667 7.9877 9.93C8.12103 10.0567 8.1877 10.2133 8.1877 10.4C8.1877 10.58 8.12103 10.7367 7.9877 10.87C7.86103 10.9967 7.70103 11.06 7.5077 11.06Z"
                                                                        fill="#FFDE2F"></path>
                                                                    <circle cx="7.5" cy="7.5" r="7"
                                                                        stroke="#FFDE2F"></circle>
                                                                </svg>
                                                                <p>Please add role first.</p>
                                                                <span>Try adding a role first, in order to delete the
                                                                    role.</span>
                                                            </div>
                                                        @endif
                                                    </div>
                                        ...
                                        <div id="divisionManagement" class="tabcontent">
                                            <h3>Division Management</h3>
                                            <div class="row">
                                                <div class="col-lg-3" style="border-right: 2px solid #ccc; padding-right: 15px;">
                                                    <button class="btn_command" style="border-radius:5px;" data-bs-toggle="modal" data-bs-target="#adddivision">
                                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <style>
                                            .filtr_tabble tbody tr td:last-child {
                                                    text-align: justify;
                                                }
                                        </style>
