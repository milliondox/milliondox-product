...
<div class="sidebar-wrapper">
        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                 ...
                 <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{url('/user/template')}}"><i data-feather="info"> </i><span>Template</span></a></li>
 ...
 <!--<li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{url('/user/wallet')}}"><i data-feather="info"> </i><span>Promoter Wallet</span></a></li> -->
                 ...
                 <li class="sidebar-list">
                    ...
                    <a class="sidebar-link sidebar-title link-nav" {{ route('logout') }}"
