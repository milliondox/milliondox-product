@extends('user.includes.compliance-regulator') @section('content')
    <!-- tap on top starts-->
...
<div class="page-header">
    <div class="header-wrapper row m-0">
      ...
      <div class="container-fluid Compliance-Regulatory">
        <div class="row">
          <div class="col-md-12">
...
<div class="tabs">
  <button class="tab-link active" onclick="openTabbb('kyc')">Regulatory Filings</button>
  <button class="tab-link" onclick="openTabbb('dsc')">Corporate Legal</button>
  <button class="tab-link" onclick="openTabbb('dsc1')">Labour Laws</button>
</div>
...
<div id="tab-kyc" class="tab active">
    ...
    <tr class="" >
                          ...
                          <td>
                            ...
                            <button class="btn btn-primary" style="border-radius:5px;" data-bs-toggle="modal" data-bs-target="#ulpd_filling1">
                            ...
                            <div class="modal fade" id="ulpd_filling1" tabindex="-1" role="dialog" aria-labelledby="ulpd_filling1" aria-hidden="true">
...
<td>
                            <div class="dropdown" >
                              ...
                              <div id="myDropdown" class="dropdown-content"> <div class="down_del">
                                ...
                                <a class="dropdown-itemm rename_nt" data-bs-toggle="modal" data-bs-target="#edit_filling_1">
                                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.75 9.33323L6.41667 11.6666H12.25V9.33323H8.75ZM7.035 4.19406L1.75 9.47906V11.6666H3.9375L9.2225 6.38156L7.035 4.19406ZM10.9142 4.6899C11.1417 4.4624 11.1417 4.08323 10.9142 3.8674L9.54917 2.5024C9.4398 2.39389 9.29198 2.33301 9.13792 2.33301C8.98385 2.33301 8.83604 2.39389 8.72667 2.5024L7.65917 3.5699L9.84667 5.7574L10.9142 4.6899Z" fill="#8D8D8D" />
                                           ...
                                           <!-- model start -->
<div class="modal fade" id="edit_filling_1" tabindex="-1" role="dialog" aria-labelledby="edit_filling_1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
...
<div id="tab-dsc" class="tab">
    ...
    <tr class="" >
                          ...
                          <td>
                            ...
                            <button class="btn btn-primary" style="border-radius:5px;" data-bs-toggle="modal" data-bs-target="#ulpd_filling2">
                              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.25 12V5.8875L6.3 7.8375L5.25 6.75L9 3L12.75 6.75L11.7 7.8375L9.75 5.8875V12H8.25ZM4.5 15C4.0875 15 3.7345 14.8533 3.441 14.5597C3.1475 14.2662 3.0005 13.913 3 13.5V11.25H4.5V13.5H13.5V11.25H15V13.5C15 13.9125 14.8533 14.2657 14.5597 14.5597C14.2662 14.8538 13.913 15.0005 13.5 15H4.5Z" fill="#7E7E7E" />
                              </svg> Upload </button>
                            <div class="modal fade" id="ulpd_filling2" tabindex="-1" role="dialog" aria-labelledby="ulpd_filling2" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" style="font-weight:700"></h5>
...
<td>
                            <div class="dropdown" >
                              ...
                              <div id="myDropdown" class="dropdown-content"> <div class="down_del">
                                ...
                                <a class="dropdown-itemm rename_nt" data-bs-toggle="modal" data-bs-target="#edit_filling_2">
                                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.75 9.33323L6.41667 11.6666H12.25V9.33323H8.75ZM7.035 4.19406L1.75 9.47906V11.6666H3.9375L9.2225 6.38156L7.035 4.19406ZM10.9142 4.6899C11.1417 4.4624 11.1417 4.08323 10.9142 3.8674L9.54917 2.5024C9.4398 2.39389 9.29198 2.33301 9.13792 2.33301C8.98385 2.33301 8.83604 2.39389 8.72667 2.5024L7.65917 3.5699L9.84667 5.7574L10.9142 4.6899Z" fill="#8D8D8D" />
                                  </svg> Edit </a>
                                           ...
                                           <!-- model start -->
<div class="modal fade" id="edit_filling_2" tabindex="-1" role="dialog" aria-labelledby="edit_filling_2" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" style="font-weight:700">Edit Doc</h5>
...
<div id="tab-dsc1" class="tab">
    ...
    <tr class="" >
                          ...
                          <td>
                            ...
                            <button class="btn btn-primary" style="border-radius:5px;" data-bs-toggle="modal" data-bs-target="#ulpd_filling3">
                              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.25 12V5.8875L6.3 7.8375L5.25 6.75L9 3L12.75 6.75L11.7 7.8375L9.75 5.8875V12H8.25ZM4.5 15C4.0875 15 3.7345 14.8533 3.441 14.5597C3.1475 14.2662 3.0005 13.913 3 13.5V11.25H4.5V13.5H13.5V11.25H15V13.5C15 13.9125 14.8533 14.2657 14.5597 14.5597C14.2662 14.8538 13.913 15.0005 13.5 15H4.5Z" fill="#7E7E7E" />
                              </svg> Upload </button>
                            <div class="modal fade" id="ulpd_filling3" tabindex="-1" role="dialog" aria-labelledby="ulpd_filling3" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" style="font-weight:700"></h5>
...
<td>
                            <div class="dropdown" >
                              ...
                              <div id="myDropdown" class="dropdown-content"> <div class="down_del">
                                ...
                                <a class="dropdown-itemm rename_nt" data-bs-toggle="modal" data-bs-target="#edit_filling_3">
                                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.75 9.33323L6.41667 11.6666H12.25V9.33323H8.75ZM7.035 4.19406L1.75 9.47906V11.6666H3.9375L9.2225 6.38156L7.035 4.19406ZM10.9142 4.6899C11.1417 4.4624 11.1417 4.08323 10.9142 3.8674L9.54917 2.5024C9.4398 2.39389 9.29198 2.33301 9.13792 2.33301C8.98385 2.33301 8.83604 2.39389 8.72667 2.5024L7.65917 3.5699L9.84667 5.7574L10.9142 4.6899Z" fill="#8D8D8D" />
                                  </svg> Edit </a>
                                           ...
                                           <!-- model start -->
<div class="modal fade" id="edit_filling_3" tabindex="-1" role="dialog" aria-labelledby="edit_filling_3" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" style="font-weight:700">Edit Doc</h5>
