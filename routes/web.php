...
->name('addTask');
Route::get('/fetch-tasks-by-date', [App\Http\Controllers\HomeController::class, 'fetchTasksByDate'])->name('fetch.tasks.by.date');
...
Route::post('/SecretarialStatutoryRegistersRS', [App\Http\Controllers\HomeController::class, 'SecretarialStatutoryRegistersRS'])->name('SecretarialStatutoryRegistersRS');
Route::get('/fetch-SecretarialStatutoryRegistersRS-data', [App\Http\Controllers\HomeController::class, 'fetchSecretarialStatutoryRegistersRSData'])->name('fetch-SecretarialStatutoryRegistersRS-data');
Route::get('/fetch-SecretarialStatutoryRegistersRS-file-data', [App\Http\Controllers\HomeController::class, 'fetchSecretarialStatutoryRegistersRSFileData'])->name('fetch-SecretarialStatutoryRegistersRS-file-data');
